...
#
# cache_in_25-10-2018_2.tcl: Tcl script for re-creating project 'cad2'
#
# Generated by Vivado on Thu Oct 25 20:31:44 +0530 2018
...
#
# 1. This project restoration tcl script (cache_in_25-10-2018_2.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/Avinash/cad2/cad2.srcs/sources_1/new/cache_in.vhd"
#    "C:/Users/Avinash/cad2/cad2.srcs/sim_1/new/tb_cache_in.vhd"
#
...
set script_file "cache_in_25-10-2018_2.tcl"
...
set orig_proj_dir "C:/Users/Avinash/cad2"
...
set_property -name "ip_output_repo" -value "C:/Users/Avinash/${_xil_proj_name_}/${_xil_proj_name_}.cache/ip" -objects $obj
set_property -name "mem.enable_memory_map_generation" -value "1" -objects $obj
set_property -name "part" -value "xc7a35tcpg236-1" -objects $obj
set_property -name "project_type" -value "Default" -objects $obj
set_property -name "pr_flow" -value "0" -objects $obj
set_property -name "sim.central_dir" -value "C:/Users/Avinash/${_xil_proj_name_}/${_xil_proj_name_}.ip_user_files" -objects $obj
...
set_property -name "top_file" -value "$proj_dir/cad2.srcs/sources_1/new/cache_in.vhd" -objects $obj
...
if { [get_files cache_in.vhd] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/Avinash/cad2/cad2.srcs/sources_1/new/cache_in.vhd
}
...
# cache_in
  ...
  set inst_0 [ create_bd_port -dir I -from 11 -to 0 inst_0 ]
  set odata_0 [ create_bd_port -dir O -from 3 -to 0 odata_0 ]

  # Create instance: cache_in_0, and set properties
  set block_name cache_in
  set block_cell_name cache_in_0
  if { [catch {set cache_in_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $cache_in_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create port connections
  connect_bd_net -net cache_in_0_odata [get_bd_ports odata_0] [get_bd_pins cache_in_0/odata]
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins cache_in_0/clk]
  connect_bd_net -net inst_0_1 [get_bd_ports inst_0] [get_bd_pins cache_in_0/inst]
